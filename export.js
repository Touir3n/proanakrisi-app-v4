...
if (tType === "ΣΩΜΑΤΙΚΗΣ ΕΡΕΥΝΑΣ ΚΑΙ ΚΑΤΑΣΧΕΣΗΣ") {
        ...
        // Διορθώθηκε για να κλίνεται αυτόματα και το φύλο: "ότι ο/η ... έχει στην κατοχή του/της ... καλέσαμε αυτόν/αυτήν"
        body = `<p style="${pStyle}">Στην ${d.city}, σήμερα την ${d.dateStr} και ώρα ${tm.start} ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρουσία και του ${d.banakr} της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β' Ανακριτικός Υπάλληλος, επειδή ενεργείται προανάκριση από την Υπηρεσία μας για παράβαση του Ν. 4139/2013 «Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις», και έχοντας βάσιμες υπόνοιες ότι ${d.a_o} ${d.prof} έχει στην κατοχή ${d.a_tou} ναρκωτικές ουσίες, καλέσαμε ${d.a_auton} όπως μας τις παραδώσει. Κατόπιν αρνητικής ${d.a_tou} απάντησης, προβήκαμε στη σωματική ${d.a_tou} έρευνα, κατά την οποία διαπιστώσαμε ότι${foundLoc} υπήρχε: ${d.v("drug_packaging")} περιέχουσα ναρκωτική ουσία, πιθανώς «${d.v("drug_type")}», συνολικού μικτού βάρους ${d.v("drug_weight")} γραμμαρίων, την οποία και κατασχέσαμε προκειμένου να αποσταλεί ως πειστήριο στον ${d.prosecutor}.</p>
        ...
        // ΧΡΗΣΗ ΓΕΝΙΚΗΣ (profGen) και προσθήκη του σωστού άρθρου (του/της)
        body = `<p style="${pStyle}">Στην ${d.city}, σήμερα την ${d.dateStr} και ώρα ${tm.start} ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρουσία και του ${d.banakr} της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β’ Ανακριτικός Υπάλληλος, επειδή ενεργείται προανάκριση από την Υπηρεσία μας για παράβαση του Ν. 4139/13 «Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις», προβήκαμε παρουσία ${d.a_tou} ${d.profGen} σε έρευνα του υπ' αριθμ. ${d.v("drug_car_plate")} ΙΧΕ αυτ/του, μάρκας ${d.v("drug_car_brand")}, χρώματος ${d.v("drug_car_color")}, καθόσον υπήρχε σοβαρό ενδεχόμενο να ανευρεθούν αντικείμενα που έχουν σχέση με την υπό έρευνα υπόθεση. Ερευνήσαμε όλους τους εσωτερικούς χώρους αυτού και εν συνεχεία${foundLoc} βρέθηκε: ${d.v("drug_packaging")} περιέχουσα ναρκωτική ουσία πιθανώς «${d.v("drug_type")}» συνολικού μικτού βάρους ${d.v("drug_weight")} γραμμαρίων, την οποία κατασχέσαμε.</p>
        <p style="${pStyle}">Κατόπιν των ανωτέρω προβήκαμε στην κατάσχεση της ναρκωτικής ουσίας και του αυτ/του μαζί με τις κρατικές πινακίδες και την άδεια κυκλοφορίας, για να αποσταλεί, η μεν ναρκωτική ουσία στο Χημείο για εξέταση και το αποτέλεσμα αυτής στον ${d.prosecutor}, το δε αυτ/το θα παραμείνει στην Υπηρεσία μας προς φύλαξη μαζί με τις κρατικές πινακίδες και την άδεια κυκλοφορίας, μέχρις ότου αποφανθεί για την τύχη του το αρμόδιο δικαστήριο.</p>
