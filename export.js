...
// Υπογραφές με 3 κενά πάνω και 3 κενά κάτω
function sigBlock(role1, role2, role3) {
    return `<br><br><br>
    <table style="width: 100%; font-family: 'Times New Roman'; font-size: 12pt; text-align: center; margin-top: 0cm; margin-bottom: 0cm; padding: 0cm; background: white; color: black; border: none;" border="0">
    <tr>
...
// Υπογραφές (4 στηλών) για Έρευνα-Κατάσχεση
...
function getD() {
    ...
    // Αφαίρεση του "του " για να ταιριάζει στη φράση "παρουσία και της/του Ανθυπαστυνόμου..."
    let banakr_clean = v("doc_banakr");
    let banakr_gen = banakr_clean;
    if(banakr_clean.startsWith("της ")) { banakr_gen = banakr_clean.substring(4); }
    else if(banakr_clean.startsWith("του ")) { banakr_gen = banakr_clean.substring(4); }
    ...
    return {
        ...
        a_o: g === 'M' ? "ο" : "η", a_os: g === 'M' ? "ο οποίος" : "η οποία",
...
function exportProkRights() {
    ...
    let d = getD(); let abm = d.v("prok_abm"); let charge = d.v("prok_charge");
    let header = `<p style="text-align: center; font-weight: bold; text-decoration: underline; font-family: 'Times New Roman'; font-size: 14pt; line-height: 115%; margin: 0cm 0cm 6pt 0cm; background: white; color: black;">ΕΚΘΕΣΗ ΓΝΩΣΤΟΠΟΙΗΣΗΣ ΔΙΚΑΙΩΜΑΤΩΝ ΥΠΟΠΤΟΥ ΚΑΤΑ ΤΗΝ ΔΙΑΡΚΕΙΑ ΠΡΟΚΑΤΑΡΚΤΙΚΗΣ ΕΞΕΤΑΣΗΣ (ΑΡ. 244 ΠΑΡ. 1 Κ.Π.Δ.)</p>`;
    
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")}΄, ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρισταμένου και του ${d.banakr} της ιδίας Υπηρεσίας προσληφθείς ως Β’ Ανακριτικού Υπαλλήλου, προσκλήθηκε ${d.a_o} κατωτέρω σημειούμεν${d.v('gender')==='M'?'ος':'η'} που ονομάζεται ${d.prof}, τ${d.a_ton} οποί${d.a_o} ενημερώσαμε ότι κατηγορείται κατά παράβαση των διατάξεων: ${charge} και εξηγήσαμε σαφώς σ’ αυτ${d.a_ton}, βάσει του άρθρου 95 του Κ.Π. Δικονομίας όλα τα εκ των άρθρων 244, 89, 90, 91, 92 παρ. 1, 95, 96, 99 παρ. 1 εδ. α, 2 και 4, 100, 101, 102, 103 και 104 του Κ.Π.Δ. δικαιώματά τ${d.a_tou} και αναλυτικότερα:</p>
    <p style="${pStyle}"><b>Άρθρο 89 του Κ.Π.Δ. – Διορισμός και αριθμός συνηγόρων των διαδίκων:</b><br>1. Κάθε διάδικος δεν μπορεί να αντιπροσωπεύεται ή να συμπαρίσταται στην ποινική διαδικασία με περισσότερους από δύο συνηγόρους στην προδικασία και τρεις στο ακροατήριο.<br>2. Ο διορισμός συνηγόρου του υπόπτου, του κατηγορουμένου ή του παριστάμενου για την υποστήριξη της κατηγορίας γίνεται: α) με προφορική δήλωση που καταχωρίζεται στα πρακτικά ή στην έκθεση εξέτασής του ως υπόπτου ή κατά την απολογία του κατηγορουμένου ή στην κατάθεσή του ως μάρτυρα ή β) με έγγραφη δήλωση κατά τις διατυπώσεις του άρθρου 42 παρ. 2 εδ. β΄ και γ΄ ή γ) με την έκθεση ή τη δήλωση άσκησης ενδίκου μέσου. Ο διορισμός παρέχει στον συνήγορο την εξουσία να εκπροσωπεί τον εντολέα του σε όλες τις διαδικαστικές πράξεις που αφορούν τη συγκεκριμένη ποινική υπόθεση, εκτός αν η πληρεξουσιότητα παρέχεται για ορισμένες μόνο από τις πράξεις αυτές.<br>Η γενική πληρεξουσιότητα περιλαμβάνει την άσκηση ενδίκων μέσων, εφόσον αυτό μνημονεύεται ρητά.</p>
    <p style="${pStyle}"><b>Άρθρο 90 του Κ.Π.Δ. – Παραίτηση από το δικαίωμα διορισμού δικηγόρου:</b><br>Με την επιφύλαξη των διατάξεων που απαιτούν την υποχρεωτική παράσταση συνηγόρου, ο ύποπτος ή ο κατηγορούμενος έχουν δικαίωμα να παραιτηθούν από τον διορισμό συνηγόρου, αφού προηγουμένως λάβουν προφορικά ή εγγράφως σαφή και επαρκή ενημέρωση σε απλή και κατανοητή γλώσσα σχετικά με το περιεχόμενο του συγκεκριμένου δικαιώματος και τις ενδεχόμενες συνέπειες της παραίτησης από αυτό. Η παραίτηση γίνεται κατά τις διατάξεις του προηγούμενου άρθρου και πρέπει να είναι προϊόν της ελεύθερης βούλησης του προσώπου και να μην περιέχει όρο ή αίρεση. Ο ύποπτος ή ο κατηγορούμενος μπορεί να ανακαλέσει την παραίτηση μεταγενέστερα, σε οποιοδήποτε στάδιο της ποινικής διαδικασίας.</p>
    <p style="${pStyle}"><b>Άρθρο 91 του Κ.Π.Δ. – Δικαίωμα παροχής δωρεάν νομικής βοήθειας:</b><br>Ο ύποπτος ή ο κατηγορούμενος έχουν δικαίωμα δωρεάν νομικής βοήθειας, το οποίο περιλαμβάνει παροχή νομικών συμβουλών και νομική αρωγή και εκπροσώπησή τους ενώπιον του δικαστηρίου, σύμφωνα με όσα ορίζονται σε σχετικές διατάξεις.</p>
    <p style="${pStyle}"><b>Άρθρο 92 παρ. 1 του Κ.Π.Δ. – Σε ποιες πράξεις παρίστανται διάδικοι:</b><br>«Οι διάδικοι έχουν δικαίωμα να παρίστανται με συνήγορο σε κάθε ανακριτική πράξη, με εξαίρεση την εξέταση των μαρτύρων και των κατηγορουμένων, εκτός αν πρόκειται για την περίπτωση της παρ. 2 του Ν.4620/2019 «Κύρωση του Κώδικα Ποινικής Δικονομίας» άρθρου 220. Γι’ αυτό το σκοπό καλούνται έγκαιρα οι διάδικοι να παρευρεθούν οι ίδιοι ή να εκπροσωπηθούν από τους συνηγόρους τους».</p>
    <p style="${pStyle}"><b>Άρθρο 95 του Κ.Π.Δ. – Δικαίωμα σε ενημέρωση:</b><br>1. Ο ύποπτος ή ο κατηγορούμενος ενημερώνεται αμέσως όσον αφορά τουλάχιστον στα ακόλουθα δικαιώματα: α) το δικαίωμα παράστασης με συνήγορο, β) το δικαίωμα και τις προϋποθέσεις παροχής δωρεάν νομικών συμβουλών, γ) το δικαίωμα ενημέρωσης σχετικά με την κατηγορία, δ) το δικαίωμα διερμηνείας και μετάφρασης και ε) το δικαίωμα σιωπής και μη αυτοενοχοποίησης.<br>2. Η ενημέρωση σύμφωνα με την παρ. 1 παρέχεται σε απλή και κατανοητή γλώσσα, προφορικώς ή εγγράφως, λαμβανομένων υπόψη των ειδικών αναγκών των υπόπτων ή κατηγορουμένων που είναι ευάλωτα πρόσωπα. Αντικείμενο της ενημέρωσης οφείλει να αποτελεί και η αναφορά των συνεπειών παραίτησης από την άσκηση των δικαιωμάτων. Για την ενημέρωση και την απάντηση του υπόπτου ή του κατηγορουμένου συντάσσεται έκθεση, η οποία και υπογράφεται.</p>
    <p style="${pStyle}"><b>Άρθρο 96 του Κ.Π.Δ – Χορήγηση εγγράφου περί δικαιωμάτων:</b><br>1. Στον ύποπτο ή τον κατηγορούμενο, ο οποίος συλλαμβάνεται ή κρατείται, παρέχεται αμέσως έγγραφο στο οποίο καταγράφονται τα δικαιώματά του και του επιτρέπεται να το διατηρεί στην κατοχή του καθ’ όλη τη διάρκεια της στέρησης της ελευθερίας του. Το έγγραφο αυτό περιλαμβάνει πληροφορίες σχετικά με τα ακόλουθα δικαιώματα: α) το δικαίωμα παράστασης με συνήγορο, β) το δικαίωμα και τις προϋποθέσεις παροχής δωρεάν νομικών συμβουλών, γ) το δικαίωμα ενημέρωσης σχετικά με την κατηγορία, δ) το δικαίωμα διερμηνείας και μετάφρασης, ε) το δικαίωμα σιωπής και μη αυτοενοχοποίησης, στ) το δικαίωμα πρόσβασης στο υλικό της δικογραφίας, ζ) το δικαίωμα ενημέρωσης των προξενικών αρχών και ενός επιπλέον προσώπου της επιλογής του, η) το δικαίωμα σε επείγουσα ιατρική περίθαλψη, θ) τον ανώτατο αριθμό ωρών ή ημερών κατά τις οποίες ο κατηγορούμενος δύναται να στερηθεί της ελευθερίας του προτού προσαχθεί ενώπιον δικαστικής αρχής και ι) πληροφορίες σχετικά με τις δυνατότητες προσβολής του νόμιμου χαρακτήρα της σύλληψης ή της κράτησης.<br>2. Το ως άνω έγγραφο συντάσσεται σε απλή και κατανοητή γλώσσα. Όταν αυτό δεν είναι διαθέσιμο στην κατάλληλη γλώσσα, ο ύποπτος ή ο κατηγορούμενος ενημερώνεται για τα δικαιώματά του προφορικά σε γλώσσα που κατανοεί. Το εν λόγω έγγραφο πρέπει στη συνέχεια να χορηγείται, χωρίς αδικαιολόγητη καθυστέρηση, σε γλώσσα που ο ύποπτος ή ο κατηγορούμενος κατανοεί.</p>
    <p style="${pStyle}"><b>Άρθρο 99 παρ. 1 εδ. α, 2 και 4 του Κ.Π.Δ. – Δικαίωμα παράστασης του κατηγορουμένου με συνήγορο:</b><br>«1. Ο Κατηγορούμενος έχει το δικαίωμα στην απολογία του και σε κάθε εξέτασή του, ακόμη και σ’ αυτήν που γίνεται σε αντιπαράσταση με μάρτυρες ή άλλους κατηγορούμενους, να παρίσταται με συνήγορο.<br>2. Επιτρέπεται σύντμηση της προθεσμίας αυτής, αν από την αναβολή δημιουργείται κίνδυνος που η ύπαρξη του βεβαιώνεται ειδικά με έκθεση του ανακριτή ή του ανακριτικού υπαλλήλου.<br>4. Σε καμία περίπτωση δεν μπορεί να απαγορευθεί η επικοινωνία του κατηγορουμένου με τον συνήγορό του.»</p>
    <p style="${pStyle}"><b>Άρθρο 100 του Κ.Π.Δ. – Δικαίωμα πρόσβασης στο υλικό της δικογραφίας - Ανακοίνωση των εγγράφων της ανάκρισης:</b><br>1. Ο ανακριτής, μόλις μετά την κλήτευσή του εμφανισθεί η οδηγηθεί σ’ αυτόν ο κατηγορούμενος για να απολογηθεί, του ανακοινώνει το περιεχόμενο του κατηγορητηρίου και των άλλων εγγράφων της ανάκρισης. Επιτρέπεται επίσης στον κατηγορούμενο να μελετήσει ο ίδιος ή ο συνήγορός του το κατηγορητήριο και τα έγγραφα της ανάκρισης. Με γραπτή αίτηση του κατηγορουμένου και με δαπάνη του χορηγούνται σ’ αυτόν αντίγραφα του κατηγορητηρίου & των εγγράφων της ανάκρισης.<br>2. Την ίδια υποχρέωση έχει και ο ανακριτής, και τα ίδια δικαιώματα ο κατηγορούμενος, όταν κληθεί ξανά σε συμπληρωματική απολογία, πάντως μετά το τέλος της ανάκρισης και προτού διαβιβασθεί η δικογραφία στον Εισαγγελέα, καλείται πάντοτε ο κατηγορούμενος να μελετήσει όλη τη δικογραφία.<br>α) Αν όμως η ανάκριση εξακολούθησε περισσότερο από μήνα μετά την πρώτη ή κάθε μεταγενέστερη απολογία, δικαιούται ο κατηγορούμενος να ασκεί τα δικαιώματά του, μία φορά το μήνα και κάθε φορά ο ανακριτής συντάσσει σχετική έκθεση κάτω από την απολογία του κατηγορουμένου.</p>
    <p style="${pStyle}"><b>Άρθρο 101 του Κ.Π.Δ. – Δικαίωμα διερμηνείας και μετάφρασης:</b><br>Ο ύποπτος ή ο κατηγορούμενος, που δεν ομιλεί ή δεν κατανοεί επαρκώς την ελληνική γλώσσα, έχει το δικαίωμα σε διερμηνεία καθώς και σε γραπτή μετάφραση όλων των ουσιωδών εγγράφων της διαδικασίας, σύμφωνα με όσα προβλέπονται στα άρθρα 233 και 237.</p>
    <p style="${pStyle}"><b>Άρθρο 102 του Κ.Π.Δ. – Δικαίωμα αίτησης διεξαγωγής αποδείξεων:</b><br>Ο κατηγορούμενος έχει δικαίωμα να ζητά με αυτοτελή αιτιολογημένη αίτησή του στον ανακριτή τη διεξαγωγή αποδείξεων προς αντίκρουση της κατηγορίας.</p>
    <p style="${pStyle}"><b>Άρθρο 103 του Κ.Π.Δ. - Προθεσμία για την απολογία:</b><br>1. Ο κατηγορούμενος έχει το δικαίωμα να ζητήσει προθεσμία τουλάχιστον 48 ώρες και δεν έχει υποχρέωση να απολογηθεί πριν περάσει η προθεσμία.<br>2. Ο ανακριτής μπορεί να παρατείνει την προθεσμία ύστερα από αίτηση του κατηγορουμένου.</p>
...
// 4. ΠΡΟΚΑΤΑΡΚΤΙΚΗ - ΕΝΙΑΙΑ (ΔΙΚΑΙΩΜΑΤΑ + ΑΝΩΜΟΤΙ)
function exportProkNoDeadline() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")} ενώπιον εμού του ${d.anakr} του ${d.deptFull}, παρουσία και του κάτωθι προσυπογεγραμμένου ${d.banakr} της ίδιας Υπηρεσίας προσληφθέντα ως Β΄ Ανακριτικού Υπαλλήλου, κατοίκων ${d.city}, εμφανίστηκε ${d.a_o} κατωτέρω σημειούμεν${d.v('gender')==='M'?'ος':'η'}, ${d.a_os}, αφού ρωτήθηκε για την ταυτότητά τ${d.a_tou} κ.λ.π., απάντησε ότι ονομάζεται ${d.prof}.</p>
    <p style="${pStyle}">Εξετάζεται χωρίς όρκο, σύμφωνα με τo άρθρο 244 παρ. 1 Κ.Π.Δ., γιατί ενεργείται προκαταρκτική εξέταση για ${charge}.</p>
    <p style="${pStyle}">Ενταύθα γνωρίσαμε σ' αυτ${d.a_ton} την πράξη που αφορά η εξέταση, ήτοι: Δυνάμει της ${abm}, ζητήθηκε η λήψη ανωμοτί (χωρίς όρκο) εξέτασης.</p>
    <p style="${pStyle}">Στη συνέχεια, εξηγήσαμε στ${d.a_ton} εξεταζόμεν${d.v('gender')==='M'?'ο':'η'}, με σαφήνεια όλα τα δικαιώματα τ${d.a_tou}, που προβλέπονται από τα άρθρα 89, 90, 91, 92 παρ. 1, 95, 96, 99 παρ. 1 εδ. α’, 2 και 4, 100, 101, 102, 103 και 104, καθώς και το δικαίωμα να διορίσει τεχνικό σύμβουλο σε περίπτωση διεξαγωγής πραγματογνωμοσύνης, εφαρμοζόμενης αναλόγως της διάταξης του άρθρου 183 και ειδικότερα, το δικαίωμα παράστασης με συνήγορο, το δικαίωμα και τις προϋποθέσεις παροχής δωρεάν νομικών συμβουλών, το δικαίωμα ενημέρωσης σχετικά με την κατηγορία, το δικαίωμα διερμηνείας και μετάφρασης, το δικαίωμα σιωπής και μη αυτοενοχοποίησης, το δικαίωμα πρόσβασης στο υλικό της δικογραφίας, το δικαίωμα ενημέρωσης των προξενικών αρχών και ενός επιπλέον προσώπου της επιλογής του, το δικαίωμα σε επείγουσα ιατρική περίθαλψη, τον ανώτατο αριθμό ωρών ή ημερών κατά τις οποίες ο κατηγορούμενος δύναται να στερηθεί της ελευθερίας του προτού προσαχθεί ενώπιον δικαστικής αρχής, το δικαίωμα άρνησης εν όλω ή εν μέρει της παροχής εξηγήσεων, το δικαίωμα προθεσμίας τουλάχιστον σαράντα οκτώ ωρών για την παροχή τους, η οποία μπορεί να παραταθεί από εκείνον που διενεργεί την προκαταρκτική εξέταση, το δικαίωμα πρότασης μαρτύρων προς εξέταση και πληροφορίες σχετικά με τις δυνατότητες προσβολής του νόμιμου χαρακτήρα της σύλληψης ή της κράτησης.</p>
    ...
    ${sigBlock(d.a_sign, "Ο Β’ Ανακριτικός Υπάλληλος", "Ο Ανακριτικός Υπάλληλος")}
    <p style="${pStyle}">Στη συνέχεια, προβήκαμε στην εξέταση τ${d.a_tou}, ως ακολούθως:</p>
...
function exportProkDeadline() {
    ...
    <p style="${pStyle}">Ύστερα από τα ανωτέρω χορηγήσαμε σε αυτ${d.a_ton} προθεσμία έως την ${d.v("prok_dead_date")} και ώρα ${d.v("prok_dead_time")} καθώς και τα σχετικά αντίγραφα. Επιπρόσθετα μας δήλωσε ότι θα απολογηθεί δια υπομνήματος.</p>
    <p style="${pStyle}">Στ${d.a_ton} ύποπτ${d.v('gender')==='M'?'ο':'η'} γνωστοποιήσαμε ότι, σύμφωνα με το άρθρο 273 § 1 του Κ.Π.Δ., υποχρεούται να δηλώσει κάθε μεταβολή της κατοικίας ή της διαμονής τ${d.a_tou}, μαζί με την ακριβή νέα τ${d.a_tou} διεύθυνση, εγγράφως, στον Εισαγγελέα του δικαστηρίου στο οποίο εκκρεμεί κατά τον χρόνο δήλωσης η δικογραφία, σύμφωνα με το άρθρο 156 του Κ.Π.Δ.</p>
    <p style="${pStyle}">Η παρούσα έκθεση άρχισε να συντάσσεται την ${d.v("doc_start")} ώρα και περατώθηκε την ${d.v("doc_end")} ώρα.</p>
    <p style="${pStyle}">Για πιστοποίηση συντάχθηκε η παρούσα έκθεση, η οποία αφού αναγνώσθηκε και βεβαιώθηκε υπογράφεται ως ακολούθως:</p>
    ${sigBlock(d.a_sign, "Ο Β’ Ανακριτικός Υπάλληλος", "Ο Ανακριτικός Υπάλληλος")}`;
...
function exportProkAfterDeadline() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")} ενώπιον εμού του ${d.anakr} του ${d.deptFull} παρουσία και του κάτωθι προσυπογεγραμμένου ${d.banakr} της ίδιας Υπηρεσίας προσληφθέντα ως Β΄ Ανακριτικού Υπαλλήλου, κατοίκων ${d.city} εμφανίστηκε ${d.a_o} κατωτέρω σημειούμεν${d.v('gender')==='M'?'ος':'η'}, ${d.a_os}, αφού ρωτήθηκε για την ταυτότητά τ${d.a_tou} κ.λ.π., απάντησε ότι ονομάζεται: ${d.prof}.</p>
    <p style="${pStyle}">Στη συνέχεια, τ${d.a_tou} ανακοινώσαμε και πάλι το περιεχόμενο των εγγράφων της προκαταρκτικής εξέτασης και τ${d.a_tou} εξηγήσαμε με σαφήνεια όλα τα δικαιώματα τ${d.a_tou}, που προβλέπονται στην παρ. 1 του άρθρου 244 του Κώδικα Ποινικής Δικονομίας.</p>
    <p style="${pStyle}">Μετά από τα παραπάνω προβήκαμε στην απαγγελία της αποδιδόμενης σ’ αυτ${d.a_ton} αξιόποινης πράξης επί της οποίας καλείται να δώσει εξηγήσεις, ως ακολούθως:</p>
    <p style="${pStyle}"><b>ΕΡΩΤΗΣΗ:</b> Έχετε κατηγορηθεί στο παρελθόν και για ποια αιτία;</p>
...
function exportArrest() {
    ...
    <p style="${pStyle}">Για πίστωση συντάχθηκε η παρούσα έκθεση, η οποία αφού αναγνώσθηκε και βεβαιώθηκε, υπογράφεται ως ακολούθως :</p>
    ${sigBlock4(d.v("gender")==='M'?"Ο Συλληφθείς":"Η Συλληφθείσα", "Ο Συλλαβών", "Ο Β΄ Ανακριτ. Υπάλλ.", "Ο Ανακριτ. Υπάλληλος")}`;
...
// 11. ΝΑΡΚΩΤΙΚΑ - ΕΞΥΠΝΗ ΚΑΤΑΣΧΕΣΗ (ΕΠΙΣΗΜΑ ΠΡΟΤΥΠΑ 2.1 ΚΑΙ 2.3)
function exportSeizure() {
    ...
    if (tType === "ΣΩΜΑΤΙΚΗΣ ΕΡΕΥΝΑΣ ΚΑΙ ΚΑΤΑΣΧΕΣΗΣ" || tType === "ΕΡΕΥΝΑΣ ΑΥΤΟΚΙΝΗΤΟΥ ΚΑΙ ΚΑΤΑΣΧΕΣΗΣ" || tType === "ΕΡΕΥΝΑΣ ΟΙΚΙΑΣ ΚΑΙ ΚΑΤΑΣΧΕΣΗΣ") {
        ...
        <p style="${pStyle}">- Ενεργούντες προανάκριση για παράβαση του Ν. 4139/2013 «Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις» όπως τροπ. με το άρθρο 10 του Ν. 4322/2015 και έχοντες βάσιμες υπόνοιες ότι ${d.a_o} ${d.prof} έχει στην κατοχή τ${d.a_tou} ναρκωτικές ουσίες, καλέσαμε αυτ${d.a_ton} όπως μας τα παραδώσει και αυτ${d.a_tou} δηλώσαντ${d.v('gender')==='M'?'ος':'ης'} ότι δεν φέρει ταύτα, προβήκαμε στη σωματική τ${d.a_tou} έρευνα, στην οποία διαπιστώσαμε ότι υπήρχαν: ${d.v("drug_packaging")} περιέχουσα ποσότητα της ναρκωτικής ουσίας «${d.v("drug_type")}» συνολικού μικτού βάρους ${d.v("drug_weight")} γραμμαρίων περίπου, τα οποία εμπίπτουν στις διατάξεις του Ν. 4139/2013 «Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις» και προβήκαμε στην κατάσχεση αυτών προκειμένου αποσταλούν ως πειστήρια στον κ. ${d.prosecutor}.</p>
        <p style="${pStyle}">- Αναφέρεται ότι η έρευνα στ${d.a_ton} ανωτέρω έγινε από εμάς.</p>
...
// 12. ΝΑΡΚΩΤΙΚΑ - ΖΥΓΙΣΗ (ΕΠΙΣΗΜΟ ΠΡΟΤΥΠΟ)
function exportWeighing() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city}, σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")} ενώπιον εμού του ${d.anakr} του ${d.deptFull}, παρουσία και του ${d.banakr} της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β’ Ανακριτικός Υπάλληλος, κατ. ενταύθα (${d.dept}), επί παρουσία και τ${d.a_tou} κατηγορούμεν${d.v('gender')==='M'?'ου':'ης'} για παράβαση του Ν.4139/13 (Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις) ${d.prof} προβήκαμε στη ζύγιση σε ηλεκτρονική ζυγαριά ακριβείας, της υπηρεσίας, της ανευρεθείσας, στ${d.a_ton} ανωτέρω κατηγορούμεν${d.v('gender')==='M'?'ο':'η'} και κατασχεθείσας ποσότητας ναρκωτικής ουσίας, ήτοι ${d.v("drug_packaging")} περιέχουσας ποσότητας ναρκωτικής ουσίας, πιθανώς «${d.v("drug_type")}» η οποία βρέθηκε να έχει συνολικό μικτό βάρος ${d.v("drug_weight")} γραμμαρίων περίπου.</p>
...
// 13. ΝΑΡΚΩΤΙΚΑ - ΓΝΩΣΤΟΠΟΙΗΣΗ (ΕΠΙΣΗΜΟ ΠΡΟΤΥΠΟ)
function exportNotification() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")} εμείς ο ${d.anakr} του ${d.deptFull}, παρουσία και του ${d.banakr}, της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β΄ Ανακριτικός Υπάλληλος, εκθέτουμε τα ακόλουθα:</p>
    <p style="${pStyle}">Καθόσον ενεργούμε προανάκριση, σύμφωνα με το άρθρο 243 παρ. 2 του Κ.Π.Δ. για παράβαση του Ν.4139/13 (Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις), όπως τροποποιήθηκε και ισχύει και έχοντες βάσιμες υπόνοιες ότι οι παραδοθείσες, σύμφωνα με την από ${d.v("doc_date")} συνταχθείσα έκθεση παράδοσης και κατάσχεσης, ${d.v("drug_packaging")} η οποία βρέθηκε στην κατοχή τ${d.a_tou} ${d.prof}, από τoν _______________, ενέχει προδήλως τις ιδιότητες των ναρκωτικών ουσιών σύμφωνα με το άρθρο 1 του Ν. 4139/2013, υπαγόμενων στον Πίνακα Β΄, «${d.v("drug_type")}» γνωστοποιήσαμε τούτο στον παραπάνω, ως και τον καλέσαμε να μας δηλώσει αν αμφισβητεί τις ιδιότητες αυτές, σύμφωνα με το άρθρο 41 Ν. 4139/2013 «Νόμος περί εξαρτησιογόνων ουσιών».</p>
