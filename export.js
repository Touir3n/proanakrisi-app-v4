...
function exportSeizure() {
    ...
    if (tType === "ΣΩΜΑΤΙΚΗΣ ΕΡΕΥΝΑΣ ΚΑΙ ΚΑΤΑΣΧΕΣΗΣ") {
        ...
        body = `<p style="${pStyle}">Στην ${d.city}, σήμερα την ${d.dateStr} και ώρα ${tm.start} ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρουσία και του ${d.banakr} της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β' Ανακριτικός Υπάλληλος, επειδή ενεργείται προανάκριση από την Υπηρεσία μας για παράβαση του Ν. 4139/2013 «Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις», και έχοντας βάσιμες υπόνοιες ότι ${d.a_o} ${d.prof} έχει στην κατοχή ${d.a_tou} ναρκωτικές ουσίες, καλέσαμε ${d.a_auton} όπως μας τις παραδώσει. Κατόπιν αρνητικής ${d.a_tou} απάντησης, προβήκαμε στη σωματική ${d.a_tou} έρευνα, κατά την οποία διαπιστώσαμε ότι${foundLoc} υπήρχε: ${d.v("drug_packaging")} περιέχουσα ναρκωτική ουσία, πιθανώς «${d.v("drug_type")}», συνολικού μικτού βάρους ${d.v("drug_weight")} γραμμαρίων, την οποία και κατασχέσαμε προκειμένου να αποσταλεί ως πειστήριο στον/ην ${d.prosecutor}.</p>
