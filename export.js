...
// 3. ΠΡΟΚΑΤΑΡΚΤΙΚΗ - ΔΙΚΑΙΩΜΑΤΑ (ΕΠΙΣΗΜΟ ΠΡΟΤΥΠΟ)
function exportProkRights() {
    ...
    let header = `<p style="text-align: center; font-weight: bold; text-decoration: underline; font-family: 'Times New Roman'; font-size: 14pt; line-height: 115%; margin: 0cm 0cm 6pt 0cm; background: white; color: black;">ΕΚΘΕΣΗ ΓΝΩΣΤΟΠΟΙΗΣΗΣ ΔΙΚΑΙΩΜΑΤΩΝ ΥΠΟΠΤΟΥ<br>ΚΑΤΑ ΤΗΝ ΔΙΑΡΚΕΙΑ ΠΡΟΚΑΤΑΡΚΤΙΚΗΣ ΕΞΕΤΑΣΗΣ (ΑΡ. 244 ΠΑΡ. 1 Κ.Π.Δ.)</p>`;
    
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")}΄, ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρισταμένου και του ${d.banakr} της ιδίας Υπηρεσίας προσληφθείς ως Β’ Ανακριτικού Υπαλλήλου, προσκλήθηκε ${d.a_o} κατωτέρω σημειούμενος που ονομάζεται ${d.prof}, τ${d.a_ton} οποί${d.a_o} ενημερώσαμε ότι κατηγορείται κατά παράβαση των διατάξεων: ${charge} και εξηγήσαμε σαφώς σ’ ${d.a_auton}, βάσει του άρθρου 95 του Κ.Π. Δικονομίας όλα τα εκ των άρθρων 244, 89, 90, 91, 92 παρ. 1, 95, 96, 99 παρ. 1 εδ. α, 2 και 4, 100, 101, 102, 103 και 104 του Κ.Π.Δ. δικαιώματά τ${d.a_tou} και αναλυτικότερα:</p>
    ...
    <p style="${pStyle}"><b>Άρθρο 92 παρ. 1 του Κ.Π.Δ. – Σε ποιες πράξεις παρίστανται διάδικοι:</b><br>Οι διάδικοι έχουν δικαίωμα να παρίστανται με συνήγορο σε κάθε ανακριτική πράξη, με εξαίρεση την εξέταση των μαρτύρων και των κατηγορουμένων. Γι’ αυτό το σκοπό καλούνται έγκαιρα οι διάδικοι να παρευρεθούν οι ίδιοι ή να εκπροσωπηθούν από τους συνηγόρους τους.</p>
    <p style="${pStyle}"><b>Άρθρο 95 του Κ.Π.Δ. – Δικαίωμα σε ενημέρωση:</b><br>Ο ύποπτος ή ο κατηγορούμενος ενημερώνεται αμέσως όσον αφορά τουλάχιστον στα ακόλουθα δικαιώματα: α) το δικαίωμα παράστασης με συνήγορο, β) το δικαίωμα και τις προϋποθέσεις παροχής δωρεάν νομικών συμβουλών, γ) το δικαίωμα ενημέρωσης σχετικά με την κατηγορία, δ) το δικαίωμα διερμηνείας και μετάφρασης και ε) το δικαίωμα σιωπής και μη αυτοενοχοποίησης.</p>
    <p style="${pStyle}"><b>Άρθρο 96 του Κ.Π.Δ – Χορήγηση εγγράφου περί δικαιωμάτων:</b><br>Στον ύποπτο ή τον κατηγορούμενο, ο οποίος συλλαμβάνεται ή κρατείται, παρέχεται αμέσως έγγραφο στο οποίο καταγράφονται τα δικαιώματά του και του επιτρέπεται να το διατηρεί στην κατοχή του καθ’ όλη τη διάρκεια της στέρησης της ελευθερίας του. Το έγγραφο αυτό περιλαμβάνει πληροφορίες σχετικά με το δικαίωμα ενημέρωσης των προξενικών αρχών, το δικαίωμα σε επείγουσα ιατρική περίθαλψη κλπ.</p>
    <p style="${pStyle}"><b>Άρθρο 99 παρ. 1 εδ. α, 2 και 4 του Κ.Π.Δ. – Δικαίωμα παράστασης:</b><br>Ο Κατηγορούμενος έχει το δικαίωμα στην απολογία του και σε κάθε εξέτασή του να παρίσταται με συνήγορο. Σε καμία περίπτωση δεν μπορεί να απαγορευθεί η επικοινωνία του κατηγορουμένου με τον συνήγορό του.</p>
    <p style="${pStyle}"><b>Άρθρο 100 του Κ.Π.Δ. – Δικαίωμα πρόσβασης στο υλικό της δικογραφίας:</b><br>Ο ανακριτής ανακοινώνει το περιεχόμενο του κατηγορητηρίου και των άλλων εγγράφων της ανάκρισης. Επιτρέπεται επίσης στον κατηγορούμενο να μελετήσει ο ίδιος ή ο συνήγορός του το κατηγορητήριο και τα έγγραφα της ανάκρισης.</p>
    <p style="${pStyle}"><b>Άρθρο 103 του Κ.Π.Δ. - Προθεσμία για την απολογία:</b><br>Ο κατηγορούμενος έχει το δικαίωμα να ζητήσει προθεσμία τουλάχιστον 48 ώρες και δεν έχει υποχρέωση να απολογηθεί πριν περάσει η προθεσμία.</p>
    <p style="${pStyle}"><b>Άρθρο 104 του Κ.Π.Δ. – Δικαίωμα σιωπής και μη αυτοενοχοποίησης:</b><br>Ο ύποπτος ή ο κατηγορούμενος έχουν δικαίωμα σιωπής και μη αυτοενοχοποίησης.</p>
    <p style="${pStyle}"><b>Άρθρο 244 παρ. 1 του Κ.Π.Δ. – Δικαιώματα του υπόπτου κατά την προκαταρκτική εξέταση:</b><br>Αν η προκαταρκτική εξέταση διενεργείται ύστερα από μήνυση ή έγκληση, το πρόσωπο καλείται υποχρεωτικώς πριν από πέντε τουλάχιστον ημέρες για την παροχή εξηγήσεων και εξετάζεται χωρίς όρκο.</p>
...
function exportProkNoDeadline() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")} ενώπιον εμού του ${d.anakr} του ${d.deptFull}, παρουσία και του κάτωθι προσυπογεγραμμένου ${d.banakr} της ίδιας Υπηρεσίας προσληφθέντα ως Β΄ Ανακριτικού Υπαλλήλου, κατοίκων ${d.city}, εμφανίστηκε ${d.a_o} κατωτέρω σημειούμεν${d.v('gender')==='M'?'ος':'η'}, ${d.a_os}, αφού ρωτήθηκε για την ταυτότητά ${d.a_tou} κ.λ.π., απάντησε ότι ονομάζεται ${d.prof}.</p>
...
function exportProkDeadline() {
    ...
    let d = getD(); let abm = d.v("prok_abm"); let charge = d.v("prok_charge");
    let header = `<p style="text-align: center; font-weight: bold; text-decoration: underline; font-family: 'Times New Roman'; font-size: 14pt; line-height: 115%; margin: 0cm 0cm 6pt 0cm; background: white; color: black;">ΕΚΘΕΣΗ ΕΞΕΤΑΣΗΣ ΧΩΡΙΣ ΟΡΚΟ ΜΕ ΧΟΡΗΓΗΣΗ ΠΡΟΘΕΣΜΙΑΣ<br>(Άρθρο 244 παρ. 1 Κ.Π.Δ.)</p>`;
    ...
    <p style="${pStyle}">Ύστερα από τα ανωτέρω χορηγήσαμε σε ${d.a_auton} προθεσμία προκειμένου να προσέλθει στην Υπηρεσία μας την ${d.v("prok_dead_date")} και ώρα ${d.v("prok_dead_time")} καθώς και τα σχετικά αντίγραφα. Επιπρόσθετα μας δήλωσε ότι θα απολογηθεί δια υπομνήματος.</p>
    <p style="${pStyle}">Στ${d.a_ton} ύποπτ${d.v('gender')==='M'?'ο':'η'} γνωστοποιήσαμε ότι, σύμφωνα με το άρθρο 273 § 1 του Κ.Π.Δ., υποχρεούται να δηλώσει κάθε μεταβολή της κατοικίας ή της διαμονής ${d.a_tou}, μαζί με την ακριβή νέα ${d.a_tou} διεύθυνση, εγγράφως, στον Εισαγγελέα του δικαστηρίου στο οποίο εκκρεμεί κατά τον χρόνο δήλωσης η δικογραφία, σύμφωνα με το άρθρο 156 του Κ.Π.Δ.</p>
    <p style="${pStyle}">Η παρούσα έκθεση άρχισε να συντάσσεται την ${d.v("doc_start")} ώρα και περατώθηκε την ${d.v("doc_end")} ώρα.</p>
    <p style="${pStyle}">Για πιστοποίηση συντάχθηκε η παρούσα έκθεση, η οποία αφού αναγνώστηκε και βεβαιώθηκε υπογράφεται ως ακολούθως:</p>
...
function exportProkAfterDeadline() {
    if (!validateRequiredFields(['surname', 'name', 'prok_abm', 'prok_charge', 'prok_plea'])) return;
    let d = getD(); let abm = d.v("prok_abm"); let charge = d.v("prok_charge");
    let header = `<p style="text-align: center; font-weight: bold; text-decoration: underline; font-family: 'Times New Roman'; font-size: 14pt; line-height: 115%; margin: 0cm 0cm 6pt 0cm; background: white; color: black;">ΕΚΘΕΣΗ ΕΞΕΤΑΣΗΣ ΧΩΡΙΣ ΟΡΚΟ ΜΕΤΑ ΑΠΟ ΠΡΟΘΕΣΜΙΑ<br>(Άρθρο 244 παρ. 1 Κ.Π.Δ.)</p>`;
...
function exportSeizure() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")}, ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρισταμένου και του ${d.banakr} της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β΄ Ανακριτικός Υπάλληλος, εκθέτουμε τα εξής:</p>`;
    
    if (tType === "ΠΑΡΑΔΟΣΗΣ ΚΑΙ ΚΑΤΑΣΧΕΣΗΣ") {
        body += `<p style="${pStyle}">Επειδή ενεργούμε προανάκριση για παράβαση Ν. 4139/13 «Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις», προβήκαμε στην κατάσχεση ${d.v("drug_packaging")}, περιέχουσας ποσότητας ναρκωτικής ουσίας, πιθανώς ${d.v("drug_type")}, μικτού βάρους ${d.v("drug_weight")} γραμμαρίων, που μας παρέδωσε ... (συμπληρώστε ποιος την παρέδωσε π.χ. ο Αστυφύλακας τάδε) και την οποία, όπως δήλωσε, βρήκε / του παρέδωσε οικειοθελώς την ${d.v("doc_date")} στην κατοχή τ${d.a_tou} ${d.prof}.</p>
...
// 13. ΝΑΡΚΩΤΙΚΑ - ΓΝΩΣΤΟΠΟΙΗΣΗ (ΕΠΙΣΗΜΟ)
function exportNotification() {
    ...
    let body = `<p style="${pStyle}">Στην ${d.city} σήμερα την ${d.dateStr} και ώρα ${d.v("doc_start")}, ενώπιον εμού του ${d.anakr} υπηρετούντος στο ${d.deptFull}, παρισταμένου και του ${d.banakr} της ιδίας Υπηρεσίας, που προσλήφθηκε ως Β΄ Ανακριτικός Υπάλληλος, εκθέτουμε τα ακόλουθα:</p>
    <p style="${pStyle}">Καθόσον ενεργούμε προανάκριση, σύμφωνα με το άρθρο 243 παρ. 2 του Κ.Π.Δ. για παράβαση του Ν.4139/13 (Νόμος περί εξαρτησιογόνων ουσιών και άλλες διατάξεις), όπως τροποποιήθηκε και ισχύει και έχοντες βάσιμες υπόνοιες ότι οι παραδοθείσες, σύμφωνα με την συνταχθείσα έκθεση παράδοσης και κατάσχεσης, ουσίες οι οποίες βρέθηκαν στην κατοχή τ${d.a_tou} ${d.prof}, ενέχουν προδήλως τις ιδιότητες των ναρκωτικών ουσιών σύμφωνα με το άρθρο 1 του Ν. 4139/2013, υπαγόμενων στον Πίνακα Β΄ «${d.v("drug_type")}», γνωστοποιήσαμε τούτο στον παραπάνω, ως και τον καλέσαμε να μας δηλώσει αν αμφισβητεί τις ιδιότητες αυτές, σύμφωνα με το άρθρο 41 Ν. 4139/2013.</p>
    ...
    <p style="${pStyle}">Η παρούσα έκθεση άρχισε να συντάσσεται την ${d.v("doc_start")} ώρα και περατώθηκε την ${d.v("doc_end")} ώρα.</p>
    <p style="${pStyle}">Για πιστοποίηση συντάχθηκε η παρούσα έκθεση, η οποία αφού αναγνώσθηκε και βεβαιώθηκε υπογράφεται ως ακολούθως:</p>
    ${sigBlock("Ο κατά του οποίου η γνωστοποίηση", "Ο Β’ Ανακριτικός Υπάλληλος", "Ο Ανακριτικός Υπάλληλος")}`;
